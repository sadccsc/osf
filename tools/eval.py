...
#for lead_time in [0]:
    ...
    if target_seas!=targetseason:
        print("season forecasted at current lead time {} is {}. Target is {}. Skipping...".format(lead_time,target_seas,targetseason))
    else:
        ...
        for metric in fcst_outputs_to_plot:
            for do_mask, mask_label in skillmasks[skill_mask_code]: 
                ...
                mapfile="{}/{}_{}{}_{}-{}_{}_{}.jpg".format(mapdir,predictand_var, metric,mask_label,predictor_name,MOS,season_params["initdate"], season_params["leadtime"])
